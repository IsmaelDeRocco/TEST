...
namespace
{
    const char* const WINDOW_TITLE = "Module4 USB DRIVE"; // Macro for window title
...
void UCreateMesh2(GLMesh& mesh)
{
    ...
    GLfloat verts[] = {
        // Vertex Positions    // Colors (r,g,b,a)
         1.5f,  1.5f, 1.0f,   1.0f, 0.0f, 0.0f, 1.0f, // Top Right Vertex 0
         1.5f, 0.5f, 1.0f,   0.0f, 1.0f, 0.0f, 1.0f, // Bottom Right Vertex 1
        0.5f, 0.5f, 1.0f,   0.0f, 0.0f, 1.0f, 1.0f, // Bottom Left Vertex 2
        0.5f,  1.5f, 1.0f,   1.0f, 0.0f, 1.0f, 1.0f, // Top Left Vertex 3

         1.5f, 0.5f, 0.0f,  0.5f, 0.5f, 1.0f, 1.0f, // 4 br  right
         1.5f,  1.5f, 0.0f,  1.0f, 1.0f, 0.5f, 1.0f, //  5 tl  right
        0.5f,  1.5f, 0.0f,  0.2f, 0.2f, 0.5f, 1.0f, //  6 tl  top
        0.5f, 0.5f, 0.0f,  1.0f, 0.0f, 1.0f, 1.0f  //  7 bl back
    };
